...
public class CustomTableView extends View {
    ...
    public CustomTableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundColor(getResources().getColor(R.color.table_divider_color));
    }
    ...
    private void initPaint() {
        mTextNormalColor = getResources().getColor(R.color.table_text_normal_color);
        mTextUnableColor =  getResources().getColor(R.color.table_text_unable_color);
        mTextSelectColor =  getResources().getColor(R.color.table_text_select_color);
        mItemBgNormalColor = getResources().getColor( R.color.table_item_bg_normal_color);
        mItemBgSelectColor = getResources().getColor(R.color.table_item_bg_select_color);
    ...
    public void setUpAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setItemHeight(a.getDimensionPixelSize(R.styleable.ScrollTableView_itemHeight1, mItemHeight));
        setItemWidth(a.getDimensionPixelSize(R.styleable.ScrollTableView_itemWidth1, mItemWidth));
        setItemMargin(a.getDimensionPixelSize(R.styleable.ScrollTableView_dataMargin1, mItemMargin));
        setTextNormalColor(a.getColor(R.styleable.ScrollTableView_textNormalColor1, mTextNormalColor));
        setTextSelectColor(a.getColor(R.styleable.ScrollTableView_textSelectColor1, mTextSelectColor));
        setTextUnableColor(a.getColor(R.styleable.ScrollTableView_textUnableColor1, mTextUnableColor));
