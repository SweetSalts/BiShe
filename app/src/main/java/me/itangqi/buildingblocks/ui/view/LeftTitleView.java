...
public class LeftTitleView extends View {
    ...
    private void initPaint() {
        mTextLeftTitleColor = getResources().getColor(R.color.table_text_secondary_color);
        mItemIndicatorColor = getResources().getColor(R.color.table_divider_color);
    ...
    public void setUpAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setTextLeftTitleColor(a.getColor(R.styleable.ScrollTableView_textLeftTitleColor1, mTextLeftTitleColor));
        setItemIndicatorColor(a.getColor(R.styleable.ScrollTableView_itemIndicatorColor1, mItemIndicatorColor));
        setIndicatorCircleRadius(a.getDimensionPixelSize(R.styleable.ScrollTableView_itemIndicatorCircleRadius1, mItemIndicatorCircleRadius));
        setItemIndicatorLineWidth(a.getDimensionPixelSize(R.styleable.ScrollTableView_itemIndicatorLineWidth1, mItemIndicatorLineWidth));
        setPaintTextNormalSize(a.getDimension(R.styleable.ScrollTableView_textTitleSize1, mTextTitleSize));
