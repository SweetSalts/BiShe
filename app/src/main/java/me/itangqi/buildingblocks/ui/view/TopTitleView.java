...
public class TopTitleView extends View {
    ...
    private void initPaint() {
        mTextTopTitleColor = getResources().getColor(R.color.table_text_secondary_color);
    ...
    public void setUpAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setPlaceHeight(a.getDimensionPixelSize(R.styleable.ScrollTableView_topPlaceHeight1, mItemPlaceHeight));
        setTextTopTitleColor(a.getColor(R.styleable.ScrollTableView_textTopTitleColor1, mTextTopTitleColor));
        setPaintTextNormalSize(a.getDimension(R.styleable.ScrollTableView_textTitleSize1, mTextNormal));
